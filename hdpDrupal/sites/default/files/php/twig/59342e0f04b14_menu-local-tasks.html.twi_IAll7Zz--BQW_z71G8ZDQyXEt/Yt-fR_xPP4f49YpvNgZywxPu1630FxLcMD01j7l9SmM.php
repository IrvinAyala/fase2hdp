...
/* themes/uikitty/templates/menu/menu-local-tasks.html.twig */
class __TwigTemplate_a67b99692bebfe8065de7612797eefd74e42c8bd7af38a1a6975366217b1ac83 extends Twig_Template
{
...
";
    ...
    {
        return "themes/uikitty/templates/menu/menu-local-tasks.html.twig";
    }
...
#}
{% if primary %}
  <h2 class=\"uk-hidden\">{{ 'Primary tabs'|t }}</h2>
  <ul class=\"uk-subnav uk-subnav-pill\">{{ primary }}</ul>
{% endif %}
{% if secondary %}
  <h2 class=\"visually-hidden\">{{ 'Secondary tabs'|t }}</h2>
  <ul class=\"uk-subnav uk-subnav-line\">{{ secondary }}</ul>
{% endif %}
";
    }
}
