...
/* themes/uikitty/templates/components/links.html.twig */
class __TwigTemplate_d0beed6a53aa98485951714099c77a3db15eca82db905416df3d3965d89da3ff extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((isset($context["links"]) ? $context["links"] : null)) {
            ...
            // line 42
            echo "<ul";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "uk-subnav uk-subnav-pill"), "method"), "html", null, true));
            echo ">";
            // line 43
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 44
                echo "<li";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "addClass", array(0 => "itemlink"), "method"), "html", null, true));
                echo ">";
                // line 45
...
$context["item"], "text_attributes", array())) {
    ...
    {
        return "themes/uikitty/templates/components/links.html.twig";
    }
...
{% if links -%}
  {%- if heading -%}
    ...
    {%- endif -%}
  {%- endif -%}
  <ul{{ attributes.addClass('uk-subnav uk-subnav-pill') }}>
    {%- for item in links -%}
      <li{{ item.attributes.addClass('itemlink') }}>
        {%- if item.link -%}
         {{ item.link }}
